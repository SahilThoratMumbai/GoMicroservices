...
// //New is the function used to create an instance of data package. It returns the type
// //Model, which embeds all the types we want to be available for ourvapplication
